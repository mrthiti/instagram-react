...
import { Navbar, Container, Form, FormControl, Image, Row, Col } from 'react-bootstrap';

function App() {
  return (
    <div className="App">
      <Navbar className="fixed-top navbar-default" bg="light" expand="sm">
        <Container>
          <Navbar.Brand href="#home"><Image src={logo} width="103" height="29" /></Navbar.Brand>
          <Navbar.Collapse className="justify-content-xl-center">
            <Form inline>
          ...
          <Image className="ml-xl-3" src="https://cdn2.thecatapi.com/images/a79.jpg" width="22" height="22" roundedCircle />
        </Container>
      </Navbar>

      <Navbar className="fixed-right navbar-default" bg="light" expand="sm">
        <Container>
          <Profile />
        </Container>
      </Navbar>

      <Container className="mt-xl-3">
        <Row>
          <Col xl={8}>
            <Row>
              <Col>
