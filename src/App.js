...
function App() {
  return (
    <div className="App">
      <nav className="navbar fixed-top navbar-default bg-light">
        <div className="container">
          <a className="navbar-brand" href="#home">
            <img src={logo} width="103" height="29" alt="Logo" />
          </a>
          ...
          <div>
            ...
            <img className="ml-xl-3 rounded-circle" src="https://cdn2.thecatapi.com/images/a79.jpg" width="22" height="22" alt="Profile" />
          </div>
